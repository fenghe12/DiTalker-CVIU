...
from ditalker.preprocessing.region_masks import convert_mask_tree, convert_region_set
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--threshold", type=int, default=1, help="Foreground threshold. Default treats any non-black pixel as foreground.")
